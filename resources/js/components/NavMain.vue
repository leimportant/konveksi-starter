...
const badgeCounts = ref<{ orders: number; customers: number }>({
  orders: 0,
  customers: 0
});
            ...
            <div class="flex items-center space-x-3">
              ...
              <span class="text-gray-700 dark:text-gray-200 flex items-center gap-1">
                ...
                <span v-if="item.href === '/order-request' || item.href === '/customers'"
                  ...
                  {{ item.href === '/order-request' ? 3 : 7 }} <!-- Ganti ini dengan real count -->
                </span>
              </span>
                ...
                <div v-if="child.children?.length"
                  ...
                  <div class="flex items-center space-x-3">
                    <component v-if="child.icon && loadedIcons[child.icon]" :is="loadedIcons[child.icon]"
                      class="h-4 w-4 text-gray-500 dark:text-gray-400" />
                    <span class="text-gray-700 dark:text-gray-200">{{ child.title }} - {{ child.href }}</span>
