    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="mx-auto max-w-7xl space-y-4 px-2 py-6">
            ...
            <div class="mb-4 flex flex-wrap items-end gap-2">
                ...
                <Input type="text" v-model="searchKey" placeholder="Search Model / Activity" class="min-w-[200px] flex-1" />
            ...
            <!-- Modern Table Report -->
            <div v-else class="relative overflow-x-auto rounded-lg bg-white shadow">
                <table class="min-w-full text-sm text-gray-800">
                    <!-- Table Header -->
                    <thead class="sticky top-0 z-10 bg-gray-50 text-xs font-semibold uppercase text-gray-600">
                        <tr>
                    ...
                    <tbody>
                        ...
                        <template v-for="item in reportStore.productionSummary" :key="item.model_id">
                            ...
                            <tr class="bg-gray-100 font-semibold hover:bg-gray-200">
                                ...
                                <td v-for="role in allActivityRoles" :key="'summary-' + role.id + '-' + item.model_id" class="px-2 py-1 text-center">
