  ...
  <AppLayout :breadcrumbs="[{ title: 'Dashboard Staff', href: '/home/staff' }]">
    <div class="space-y-6 p-6">
      ...
      <div class="rounded-xl border border-green-300 bg-green-50 p-4 shadow-sm flex items-center justify-between">
        <div>
          <h2 v-if="user.employee_status && user.employee_status.toUpperCase() === 'OWNER'"
            class="text-sm font-medium text-gray-600">Total Kasbon Karyawan</h2>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
        <!-- Buat Kasbon -->
        <div @click="$inertia.visit('/kasbon/create')" class="flex flex-col items-center justify-center rounded-xl p-4 shadow-sm cursor-pointer
        ...
        <!-- History Kasbon -->
        <div @click="$inertia.visit('/kasbon')" class="flex flex-col items-center justify-center rounded-xl p-4 shadow-sm cursor-pointer
        ...
        <!-- History Pembayaran -->
        <div @click="$inertia.visit('/kasbon/mutasi')" class="flex flex-col items-center justify-center rounded-xl p-4 shadow-sm cursor-pointer
