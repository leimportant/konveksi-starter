        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div v-if="showUploadProofModal"
                ...
                <div class="w-full max-w-md rounded-lg bg-white p-4 shadow-xl">
                    ...
                    <p class="mb-4 text-center">Pesanan Anda berhasil dibuat. Silakan transfer total pembayaran ke
                        rekening berikut:</p>
                    ...
                    <label for="paymentProofUpload" class="mb-2 block text-sm font-medium text-gray-700">Unggah Bukti
                        Transfer</label>
                    ...
                    <div class="flex justify-end gap-2">
                        <Button @click="uploadPaymentProof"
                            class="rounded-md bg-indigo-600 py-2 text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500">Kirim
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="mt-8 flex justify-end space-x-4">
                            <Button @click="goBackToCart"
                                class="w-full rounded-md bg-orange-600 py-2 text-white hover:bg-orange-700 focus:ring-2 focus:ring-indigo-500">Batal</Button>
                            <Button @click="confirmCheckout"
                                class="w-full rounded-md bg-indigo-600 py-2 text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500">Proses</Button>
                        </div>
                    </div>
                </div>
            </div>
