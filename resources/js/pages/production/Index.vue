...
// ✅ Hitung Total Price per Pcs (kalau kamu juga mau total semua price_per_pcs)
            ...
            <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex flex-1 gap-2">
                    <Button
                        ...
                        class="flex flex-shrink-0 items-center gap-2 rounded-md bg-indigo-600 px-3 py-2 text-sm font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500"
                    >
                        <Plus class="h-4 w-4" />
                        Tambah Data
                    </Button>
                    <Input v-model="searchQuery" placeholder="Search..." class="flex-1 text-sm" @keyup.enter="fetchData(1)" />
                </div>
            </div>
                    ...
                    <table class="min-w-full table-auto text-left text-sm text-gray-800 dark:text-gray-100">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="whitespace-normal px-3 py-2 align-top">
